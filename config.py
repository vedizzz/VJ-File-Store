...
PICS = (environ.get('PICS', 'https://graph.org/file/3ad8048ca8b06afe3648f-cf2818473b939ac450.jpg')).split(https://graph.org/file/54ff5a900fda2934d26ca-7561527b8520ca66a0.jpg) # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5906206984').split(6969391120)]
BOT_USERNAME = environ.get("BOT_USERNAME", "Spidy Hotstar") # without @
...
CDB_NAME = environ.get("CDB_NAME", "nithish7uy")
